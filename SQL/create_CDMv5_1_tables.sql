...
CREATE TABLE IF NOT EXISTS public.attribute_definition (
...
CREATE TABLE IF NOT EXISTS public.fact_relationship 
    ( 
...
CREATE TABLE IF NOT EXISTS public.visit_cost 
    ( 
...
CREATE TABLE IF NOT EXISTS public.procedure_cost 
    ( 
...
CREATE TABLE IF NOT EXISTS public.drug_cost 
    (
...
CREATE TABLE IF NOT EXISTS public.device_cost 
    (
...
CREATE TABLE IF NOT EXISTS public.cohort_attribute 
    ( 
	 cohort_definition_id			INTEGER			NOT NULL , 
     cohort_start_date				DATE			NOT NULL , 
     cohort_end_date				DATE			NOT NULL , 
...
CREATE TABLE IF NOT EXISTS public.drug_era 
    ( 
...
CREATE TABLE IF NOT EXISTS public.dose_era 
    (
...
create sequence public.drug_era_sequence;
alter table public.drug_era alter drug_era_id set default nextval('public.drug_era_sequence');


CREATE TABLE IF NOT EXISTS public.condition_era 
    ( 
...
create sequence public.condition_era_sequence;
alter table public.condition_era alter condition_era_id set default nextval('public.condition_era_sequence');
